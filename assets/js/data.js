...
const PROFILE = {
  ...
  education: [
    {
      program: "MCA – Jamia Millia Islamia",
      cgpa: "8.51",
      year: "Expected 2026",
    },
    { program: "BCA – SSDC Kanpur (CSJMU)", perc: "73.75%", year: "2020" },
    {
      program: "Senior Secondary (XII) – SGVP Inter College (UP Board)",
      perc: "84%",
      year: "2017",
    },
    {
      program: "Secondary (X) – SGVP Inter College (UP Board)",
      perc: "82%",
      year: "2015",
    },
  ],
  ...
  projects: [
    {
      ...
      links: {
        repo: "https://github.com/mdsddm/Valexia",
        live: "https://valexia.onrender.com",
      },
    ...
    },
    {
      ...
      links: {
        repo: "https://github.com/mdsddm/airbnb-clone",
        live: "https://staynest-qfkg.onrender.com/",
      },
    ...
    },
    {
      ...
      tech: ["Python", "MySQL"],
      links: {
        repo: "https://github.com/mdsddm/Cyber-Security-Management-System",
        live: "#",
      },
    ...
    },
    {
      ...
      links: {
        repo: "https://github.com/mdsddm/mdsddm.github.io",
        live: "https://mdsddm.github.io",
      },
