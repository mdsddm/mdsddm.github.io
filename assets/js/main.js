...
function setupScrollReveal() {
  ...
  const targets = document.querySelectorAll(
    ".v3-section, .bento-item, .section-title, .v3-hero__text",
  );
...
function renderProjects() {
  ...
  grid.innerHTML = PROFILE.projects
    ...
    .map((proj, index) => {
      return `
            <article class="bento-item card--project" data-live-url="${proj.links.live}" onclick="navigateToProject(this)">
                <div class="media">
                ...
                <div class="project-body">
                    ...
                    <div class="project-actions">
                        <a href="${proj.links.repo}" target="_blank" class="btn btn--sm btn--outline" onclick="event.stopPropagation()">
